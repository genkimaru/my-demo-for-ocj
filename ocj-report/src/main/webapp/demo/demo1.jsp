...
// 			//将表单数据作为条件发送
// 			 					$.ajax({ 
// 						url: "${pageContext.request.contextPath}/ws/customer/customer/search", 
// 						type:"GET",
...
// 							$.messager.alert('警告','查询失败','warning');
// 						}
// 				})  
...
<body class="easyui-layout" style="visibility:hidden;">
    <div region="east" title="查询条件" icon="icon-forward" style="width:250px;overflow:auto;" split="false" border="true" >
		...
		<form id="form" method="post" >
			<table class="table-edit" width="100%" >				
				<tr><td>
					<b>地址</b><span class="operator"><a name="username-opt" opt="all"></a></span>
...
<!-- 					<b>至</b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" id="_birthday2" name="_birthday2" value="1988-11-11" class="easyui-datebox" /> -->
<!-- 				</td></tr> -->
    ...
    <div region="center" style="overflow:hidden;" border="false">
		<iframe id="list" src="${pageContext.request.contextPath }/demo/customer.jsp" scrolling="no" style="width:100%;height:100%;border:0;"></iframe>
    </div>
</body>
</html>