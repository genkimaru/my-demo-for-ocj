...
<script type="text/javascript">
	...
	$(function(){
		...
		// 为 button-import 添加一键上传效果
		$("#button-import").upload({
			action : '${pageContext.request.contextPath}/subarea_importXls.action', //请求提交到哪
			enctype: 'multipart/form-data', // 上传编码方式
			name : 'upload', //服务器叫接收，需要name ---- <input type="file" name="upload" />
			onComplete : function(){
				// 上传成功
				alert("上传成功！");
