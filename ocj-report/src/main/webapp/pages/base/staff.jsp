	...
	$(function(){
		...
		$("#save").click(function(){
			...
			$("#staffForm").form('submit',{
				url : '${pageContext.request.contextPath}/staff_add.action',
				success : function(data){
					// 成功后函数
					data = eval("("+data+")");// 执行字符串，转换为js对象，去掉""
					if(data == "success"){
						// 提示信息
						$.messager.alert("提示","取派员添加成功！","info");
						// 关闭window
			...
			<form id="staffForm" method="post">
				<table class="table-edit" width="80%" align="center">
					...
					<tr>
						<td>取派标准</td>
						<td>
							<!-- 保存在 model（staff）中 standard属性 中 id 属性中  -->
							<input class="easyui-combobox" name="standard.id"  
    							data-options="valueField:'id',textField:'name',url:'${pageContext.request.contextPath }/standard_ajaxlist.action'" />  
						</td>
					</tr>
					</table>
			</form>
