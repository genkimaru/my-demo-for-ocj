  	...
  	<table id="grid" class="easyui-datagrid" rownumbers="true" fit="true">  
  		<thead>
  			<tr>
  				...
  				<th data-options="field:'pick'" width="200">拾取任务</th>
  				...
  				<th data-options="field:'receiveinfo'" width="200">签收信息</th>
  		...
  		<tbody>
  			<s:iterator value="#zhongZhuanInfoList" var="zhongZhuanInfo">
  				<tr>
  					...
  					<td>
						<s:a action="task_takeTask" cssClass="easyui-linkbutton">拾取任务
