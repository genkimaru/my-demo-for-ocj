  	...
  	<table id="grid" class="easyui-datagrid" rownumbers="true" fit="true">  
  		<thead>
  			<tr>
  				...
  				<th data-options="field:'instore'" width="200">入库信息</th>
  				<th data-options="field:'outstore'" width="200">出库信息</th>
  		...
  		<tbody>
  			<s:iterator value="#zhongZhuanInfoList" var="zhongZhuanInfo">
  				<tr>
  					...
  					<!-- 显示中转信息 .... -->
  					<td><s:property value="#zhongZhuanInfo.inStore"/> </td>
  					<td><s:property value="#zhongZhuanInfo.outStore"/> </td>
  					<td>
						<s:a action="page_zhongzhuan_receiveinfo_complete" cssClass="easyui-linkbutton">办理任务
